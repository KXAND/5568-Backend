...
library BorrowLogic {
  ...
  function executeBorrow(
    ...
    debtVault.borrowedPrincipal[asset] += amount / debtVault.borrowedIndex[asset];
  ...
  function executeRepay(
    ...
    uint256 currentDebt = ReserveLogic.borrowBalance(debtVaults, debtVaultId, asset, reserve);
